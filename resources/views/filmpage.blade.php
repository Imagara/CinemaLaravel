                          ...
                          <div class="vPib8WA0Q1LBbqmrmssw9w==">
                                  <div class="jsOTYX0pH3oBjSKDdxqB+g==">
                                          <div class="vM5TY03rTJnyg7crh8SJog==">
                                                  ...
                                                  <img src="{{ Storage::url($movie->picture) }}" alt=""
                                          ...
                                          <div class="rcHM9OILKxbxImTkB1pK3w==">
                                                  <ul class="crIyOI3mLKETpDMVzHGm8A==">
                                                          ...
                                                          <li class="ch0kxyCKroW+uLE+V2Wwuw==">
                                                                  ...
                                                                  <div class="PbfbBzFoBaCyzC8lPAjUOg==">
                                                                  {{\Carbon\Carbon::createFromFormat('Y-m-d', $movie->premiere)->format('m.d.Y')}}
                                                                  </div>
                                                          </li>
                                                  </ul>
                                          </div>
                                  </div>
                                  <div class="Ro14HRU8UV7tl9Nli0GiUg==">
                                          <div class="s0yJuTknJkrvvHvKRx1h8w==">
                                               <a class="ihOPr5gPPBXS8OHkFFwM2w== undefined" href="/ticket" onmouseover="this.style.color='red'" onmouseout="this.style.color='white'" style="color: white; ">Купить билет</a>
                                          </div>
                                  </div>
                          </div>
                  </div>
